    ...
    <div className="py-16 bg-gradient-to-b from-violet-50 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose prose-indigo max-w-none">
          ...
          <p>
            Welcome to Interview Copilot. We respect your privacy and are committed to protecting your personal data.
          ...
          <ul>
            ...
            <li>
              <strong>Interview Data</strong> includes transcripts and recordings of your practice interview sessions.
            </li>
          </ul>
